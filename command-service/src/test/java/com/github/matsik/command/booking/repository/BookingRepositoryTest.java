...
@SpringBootTest(classes = {
        BookingRepositoryTest.TestCassandraConfig.class,
...
class BookingRepositoryTest {
    ...
    @Autowired
    private BookingRepositoryCassandra bookingRepository;
    ...
    @EnableCassandraRepositories(basePackageClasses = BookingRepositoryCassandra.class)
    ...
    void createBooking(
        ...
        // when
        bookingRepository.createBooking(command);
    ...
    void deleteBooking(
        ...
        // when
        bookingRepository.deleteBooking(command);
